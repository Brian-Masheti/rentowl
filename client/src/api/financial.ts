...
export async function fetchFinancialReports(token: string) {
...
export async function fetchMonthlyIncome(token: string) {
...
export async function fetchRentArrears(token: string) {
...
export async function fetchOccupancyStats(token: string) {
