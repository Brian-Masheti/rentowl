...
const TenantSidebar: React.FC<TenantSidebarProps> = ({ onSelect, selected }) => {
  ...
  return (
    ...
    >
      <div className={`font-bold text-2xl mb-8 px-4 py-2 transition-all duration-300 ${expanded ? 'text-left' : 'text-center'}`}>{expanded ? 'Tenant' : '🏠'}</div>
